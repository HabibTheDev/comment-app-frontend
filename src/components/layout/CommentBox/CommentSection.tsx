...
import { setTotalComments } from "../../../redux/features/comment/commentSlice";
...
const CommentSection = () => {
  ...
  } = useGetAllCommentQuery({ page, limit, sort });
  ...
  useEffect(() => {
    if (commentsData) {
      dispatch(setTotalComments(commentsData?.data?.meta?.total || 0));
    }
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-4 flex justify-center space-x-2">
              {Array.from(
                { length: Math.ceil(commentsData?.data.total / limit) },
                (_, index) => (
                  <button
                    key={index + 1}
